-- Migration: 20260507_invitation_onboarding_role_location.sql
-- Goal:
-- 1) Capture onboarding metadata on invitations: company role + assigned location
-- 2) Propagate this metadata to org_members when invitation is accepted
...
BEGIN
    ...
    VALUES (
        ...
        pg_catalog.nullif(pg_catalog.btrim(v_invitation.job_title), ''),
