    ...
    return (
        <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-[#0034a1]">Catálogo de conceptos</h2>
                    <p className="text-muted-foreground font-medium">
                        Precios y códigos para cotizaciones.
                    </p>
                </div>
                <Button onClick={openCreate} className="shrink-0 bg-[#0034a1] hover:bg-[#0034a1]/90 w-full sm:w-auto">
