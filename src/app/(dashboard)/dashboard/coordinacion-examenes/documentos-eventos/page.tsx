            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Seguimiento documental por evento y por área (coordinación de exámenes).
                    </p>
                </div>
            </div>
                ...
                <CardContent className={mainView === "events"
                    ...
                    {mainView === "events" && filteredEvents.map((event) => {
                        ...
                        return (
                            <button
                                key={event.id}
                                onClick={() => router.push(`/dashboard/coordinacion-examenes/documentos-eventos/${event.id}`)}
                                className={cn(
                    ...
                    {mainView === "gantt" && (
                        <div className="space-y-2">
                            {ganttData.rows.map((row) => (
                                <button
                                    key={row.id}
                                    onClick={() => router.push(`/dashboard/coordinacion-examenes/documentos-eventos/${row.id}`)}
