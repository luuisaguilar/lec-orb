...
export default function InstitucionalCoordinacionProyectosPage() {
    ...
    return (
        <div className="flex flex-col gap-6 p-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight">Institucional - Coordinación de Exámenes</h1>
                <p className="max-w-3xl text-muted-foreground">
                    Este submódulo de proyectos es operativo para coordinación institucional de exámenes. Integra datos de
                    Eventos, CENNI y Códigos para gestionar pendientes y ejecución diaria. El módulo transversal de empresa vive en
            ...
            <div className="grid gap-3 md:grid-cols-3">
                <MetricCard
                    ...
                    description="Publicados o en ejecución"
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Acceso rápido de coordinación</CardTitle>
                    <CardDescription>Entradas directas a los módulos que alimentan Coordinación de Exámenes.</CardDescription>
                </CardHeader>
                <CardContent className="grid gap-2 md:grid-cols-2 xl:grid-cols-3">
                    <QuickLink href="/dashboard/eventos" title="Eventos" description="Planeación y ejecución de eventos" />
                    <QuickLink href="/dashboard/institucional/documentos-eventos" title="Documentos de eventos" description="Control documental por evento" />
                    <QuickLink href="/dashboard/cenni" title="CENNI" description="Seguimiento de trámites y estatus" />
                    <QuickLink href="/dashboard/codigos" title="Códigos de examen" description="Disponibilidad y control de códigos" />
                    <QuickLink href="/dashboard/toefl/codigos" title="TOEFL - Códigos" description="Lotes y disponibilidad TOEFL" />
                    <QuickLink href="/dashboard/toefl/administraciones" title="TOEFL - Administraciones" description="Calendario operativo TOEFL" />
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Quick win operativo para priorizar trabajo del día.</CardDescription>
                </CardHeader>
                <CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    />
                    <PendingCard
                        title="Códigos examen disponibles"
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Seguimiento institucional</CardTitle>
                    <CardDescription>Resumen de eventos recientes para coordinación.</CardDescription>
                </CardHeader>
