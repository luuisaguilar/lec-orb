...
describe("Quotes API Route", () => {
    ...
    describe("POST /api/v1/quotes", () => {
        it("should create quote and return 201", async () => {
            ...
            expect(body.quote.folio).toBe("COT-2024-001");
        });
        ...
        it("should return 400 when status is invalid", async () => {
            const req = new NextRequest("http://localhost/api/v1/quotes", {
                method: "POST",
                body: JSON.stringify({ folio: "Q-001", status: "WRONG" }),
            });
        ...
        it("should default status to PENDING when not provided", async () => {
            mockSupabase._data = { id: "q-def", folio: "COT-003", status: "PENDING", org_id: "org-uuid-001" };

            const req = new NextRequest("http://localhost/api/v1/quotes", {
                method: "POST",
                body: JSON.stringify({ folio: "COT-003" }),
            });
